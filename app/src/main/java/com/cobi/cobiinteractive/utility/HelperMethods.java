package com.cobi.cobiinteractive.utility;
...
public class HelperMethods {
    ...
    //MOST OF THESE ARE NOT USED OR THIS PROJECT, THESE ARE JUST SOME HELPFUL METHODS I HAVE USED IN
    ...
    /**
     * Display options for image loading
     * @return Display options
     */
    public static DisplayImageOptions getDisplayOption(){
        return new DisplayImageOptions.Builder()
                .showImageForEmptyUri(R.drawable.temp_no_photo)
                .showImageOnFail(R.drawable.temp_no_photo)
                .cacheInMemory(true)
                .cacheOnDisk(true)
